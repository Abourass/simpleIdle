...
export type jobCategories = 'computer' | 'food' | 'fame' | 'service' | 'crime';
...
export class Careers {
  ...
  listOfJobPaths = (stats: iStats) => {
    ...
    const containsOpenPositions = (jobCategory: jobCategories, potentialBranch: Position[]) => {
  ...
  searchPath(category: jobCategories): JobPath {
    switch (category){
      case 'computer': { return this.paths.computerPath; }
      case 'food': { return this.paths.foodPath; }
      case 'fame': { return this.paths.famePath; }
      case 'service': { return this.paths.servicePath; }
      case 'crime': { return this.paths.crimePath; }
    }
  };
...
export const careers = () => ({
  ...
  load: function(careers: iPath){ return new Careers(careers) }
});
